...
A World of Warcraft addon that displays FPS and latency as visual status bars that update in real-time.

**Website:** [peavers.io](https://peavers.io) | **Addon Backup:** [vault.peavers.io](https://vault.peavers.io) | **Issues:** [GitHub](https://github.com/peavers-warcraft/PeaversSystemBars/issues)
